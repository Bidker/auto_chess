...
from narzedzia_pol import zmienWspolrzedneNaPole, wyznaczWspolrzednePoPozycji, czyWszpolrzedneWPolu
from narzedzia_pol import zmienListeWspolrzednychNaPola, zmienListePolNaWspolrzedne
