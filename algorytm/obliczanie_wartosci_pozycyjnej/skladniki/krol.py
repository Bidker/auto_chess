    ...
    def wartosciZaPolozenieKrola(self):
        wartosci_pol = {
            warunki_biale: {
                ...
                'f1': 5, 'd1': -5, 'c2': -40, 'd2': -40, 'f2': -40, 'a3': -100, 'b3': -100, 'c3': -100,
                'd3': -100, 'e3': -100, 'f3': -100, 'g3': -100, 'h3': -100, 'a4': -200, 'b4': -200,
                'c4': -200, 'd4': -200, 'e4': -200, 'f4': -200, 'g4': -200, 'h4': -200,
            },
            warunki_czarne: {
                'b8': 25, 'g8': 25, 'b7': 15, 'a8': 15, 'g7': 15, 'h8': 15, 'c8': 10, 'a7': 10, 'h7': 10,
                'f8': 5, 'd8': -5, 'c7': -40, 'd7': -40, 'f7': -40, 'a6': -100, 'b6': -100, 'c6': -100,
                'd6': -100, 'e6': -100, 'f6': -100, 'g6': -100, 'h6': -100, 'a5': -200, 'b5': -200,
